...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__edit__ = __webpack_require__(1934);
...
var AddonModWikiEditPageModule = (function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_sync__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_utils_dom__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_utils_text__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_wiki__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_wiki_offline__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_wiki_sync__ = __webpack_require__(254);
// (C) Copyright 2015 Martin Dougiamas
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
 ...
 */
var AddonModWikiEditPage = (function () {
    ...
    AddonModWikiEditPage.prototype.fetchWikiPageData = function () {
        ...
        if (this.pageId) {
            ...
            promise = this.wikiProvider.getPageContents(this.pageId).then(function (pageContents) {
                ...
                return _this.domUtils.isRichTextEditorEnabled();
                ...
                var content = _this.rteEnabled ? _this.textUtils.replacePluginfileUrls(editContents.content, _this.subwikiFiles) :
                    ...
                    if (id > 0) {
                        ...
                        return _this.wikiProvider.getPageContents(_this.pageId).then(function (pageContents) {
                            ...
                            _this.eventsProvider.trigger(__WEBPACK_IMPORTED_MODULE_11__providers_wiki__["a" /* AddonModWikiProvider */].PAGE_CREATED_EVENT, {
                                ...
                                subwikiId: _this.subwikiId,
                                pageTitle: title,
                                siteId: _this.sitesProvider.getCurrentSiteId()
                            });
                        });
                    }
                    else {
